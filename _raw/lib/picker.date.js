...
function DatePicker( picker, settings ) {
    ...
    calendar.
        ...
        set( 'select',
            ...
            { format: elementDataValue ? settings.formatSubmit : settings.format, data: !!elementDataValue, currentCentury: settings.formatShortYear }
        )
...
DatePicker.prototype.create = function( type, value, options ) {
    ...
    // If it’s an array, convert it into a date.
        ...
        //when you are using 'yy' format, you can modify the century using formatShortYear.
        if( value[ 0 ].length == 2 && options.currentCentury ) {
            value[ 0 ] = ( parseInt( options.currentCentury, 10 ) /100 ) + value[ 0 ]
        }
