...
describe('/dateUtil', () => {
  ...
  describe('#format', () => {
    ...
    it(
      'formats a date object with a given template that has escaped characters',
    () => {

      const dateObject = new Date(2014, 3, 2)

      dateUtil
        .format(dateObject, 'ESCAPED CHARS [YYYY] MMMM DD', LANGUAGE.ENGLISH)
      ...
      dateUtil
        .format(dateObject, '[MMM SO YUMMAY! @ ]YYYY MM DD', LANGUAGE.ENGLISH)
      ...
      dateUtil
        .format(dateObject, '[YEP MMM YUMMAY]! @ YYYY MM DD', LANGUAGE.ENGLISH)
    ...
    describe('(HOOK_FORMATTER.D)', () => {
      it('formats a date object as the date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'D', LANGUAGE.ENGLISH)
          .should.eql('2')

        dateUtil
          .format(new Date(2014, 3, 17), 'D', LANGUAGE.ENGLISH)
          .should.eql('17')
    ...
    describe('(HOOK_FORMATTER.DD)', () => {
      it('formats a date object as the padded date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'DD', LANGUAGE.ENGLISH)
          .should.eql('02')

        dateUtil
          .format(new Date(2014, 3, 17), 'DD', LANGUAGE.ENGLISH)
          .should.eql('17')
    ...
    describe('(HOOK_FORMATTER.DDD)', () => {
      it('formats a date object as the short named date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'DDD', LANGUAGE.ENGLISH)
          .should.eql('We')

        dateUtil
          .format(new Date(2014, 3, 17), 'DDD', LANGUAGE.ENGLISH)
          .should.eql('Th')
    ...
    describe('(HOOK_FORMATTER.DDDD)', () => {
      it('formats a date object as the full named date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'DDDD', LANGUAGE.ENGLISH)
          .should.eql('Wednesday')

        dateUtil
          .format(new Date(2014, 3, 17), 'DDDD', LANGUAGE.ENGLISH)
          .should.eql('Thursday')
    ...
    describe('(HOOK_FORMATTER.M)', () => {
      it('formats a date object as the date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'M', LANGUAGE.ENGLISH)
          .should.eql('4')

        dateUtil
          .format(new Date(2014, 11, 17), 'M', LANGUAGE.ENGLISH)
          .should.eql('12')
    ...
    describe('(HOOK_FORMATTER.MM)', () => {
      it('formats a date object as the padded date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'MM', LANGUAGE.ENGLISH)
          .should.eql('04')

        dateUtil
          .format(new Date(2014, 11, 17), 'MM', LANGUAGE.ENGLISH)
          .should.eql('12')
    ...
    describe('(HOOK_FORMATTER.MMM)', () => {
      it('formats a date object as the short named date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'MMM', LANGUAGE.ENGLISH)
          .should.eql('Apr')

        dateUtil
          .format(new Date(2014, 11, 17), 'MMM', LANGUAGE.ENGLISH)
          .should.eql('Dec')
    ...
    describe('(HOOK_FORMATTER.MMMM)', () => {
      it('formats a date object as the full named date', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'MMMM', LANGUAGE.ENGLISH)
          .should.eql('April')

        dateUtil
          .format(new Date(2014, 11, 17), 'MMMM', LANGUAGE.ENGLISH)
          .should.eql('December')
    ...
    describe('(HOOK_FORMATTER.YYYY)', () => {
      it('formats a date object as the year', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2), 'YYYY', LANGUAGE.ENGLISH)
          .should.eql('2014')

        dateUtil
          .format(new Date(2014, 11, 17), 'YYYY', LANGUAGE.ENGLISH)
          .should.eql('2014')
    ...
    describe('(HOOK_FORMATTER.H)', () => {
      it('formats a date object as the 24-hours', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4), 'H', LANGUAGE.ENGLISH)
          .should.eql('4')

        dateUtil
          .format(new Date(2014, 11, 17, 18), 'H', LANGUAGE.ENGLISH)
          .should.eql('18')

        dateUtil
          .format(new Date(2014, 11, 17, 23), 'H', LANGUAGE.ENGLISH)
          .should.eql('23')
    ...
    describe('(HOOK_FORMATTER.HH)', () => {
      it('formats a date object as the padded 24-hours', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4), 'HH', LANGUAGE.ENGLISH)
          .should.eql('04')

        dateUtil
          .format(new Date(2014, 11, 17, 18), 'HH', LANGUAGE.ENGLISH)
          .should.eql('18')

        dateUtil
          .format(new Date(2014, 11, 17, 23), 'HH', LANGUAGE.ENGLISH)
          .should.eql('23')
    ...
    describe('(HOOK_FORMATTER.h)', () => {
      it('formats a date object as the 12-hours', () => {
        ...
        dateUtil
          .format(new Date(2014, 11, 17, 12), 'h', LANGUAGE.ENGLISH)
          .should.eql('12')
    ...
    describe('(HOOK_FORMATTER.m)', () => {
      it('formats a date object as the minutes', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4, 7), 'm', LANGUAGE.ENGLISH)
          .should.eql('7')

        dateUtil
          .format(new Date(2014, 11, 17, 18, 49), 'm', LANGUAGE.ENGLISH)
          .should.eql('49')
    ...
    describe('(HOOK_FORMATTER.mm)', () => {
      it('formats a date object as the padded minutes', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4, 7), 'mm', LANGUAGE.ENGLISH)
          .should.eql('07')

        dateUtil
          .format(new Date(2014, 11, 17, 18, 49), 'mm', LANGUAGE.ENGLISH)
          .should.eql('49')
    ...
    describe('(HOOK_FORMATTER.a)', () => {
      it('formats a date object as the lower-case meridiem', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4, 7), 'a', LANGUAGE.ENGLISH)
          .should.eql('a.m.')

        dateUtil
          .format(new Date(2014, 11, 17, 18, 49), 'a', LANGUAGE.ENGLISH)
          .should.eql('p.m.')
    ...
    describe('(HOOK_FORMATTER.s)', () => {
      it('formats a date object as the padded seconds', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4, 7, 51), 's', LANGUAGE.ENGLISH)
          .should.eql('51')

        dateUtil
          .format(new Date(2014, 11, 17, 18, 49, 3), 's', LANGUAGE.ENGLISH)
          .should.eql('3')
    ...
    describe('(HOOK_FORMATTER.ss)', () => {
      it('formats a date object as the padded seconds', () => {
        ...
        dateUtil
          .format(new Date(2014, 3, 2, 4, 7, 51), 'ss', LANGUAGE.ENGLISH)
          .should.eql('51')

        dateUtil
          .format(new Date(2014, 11, 17, 18, 49, 3), 'ss', LANGUAGE.ENGLISH)
          .should.eql('03')
    ...
    describe('(HOOK_FORMATTER.x)', () => {
      it('formats a date object as unix timestamp', () => {
        ...
        dateUtil
          .format(date1, 'x', LANGUAGE.ENGLISH)
          .should.eql(`${date1.getTime()}`)

        const date2 = new Date(2014, 11, 17, 18, 49, 3)
        dateUtil
          .format(date2, 'x', LANGUAGE.ENGLISH)
          .should.eql(`${date2.getTime()}`)
  ...
  describe('#parse', () => {
    ...
    it(
      'parses a date string with a given template that has escaped characters',
    () => {
      ...
      dateUtil
        .parse(
          'ESCAPE THE D! 2014-4-20',
          'ESCAPE THE [D]! YYYY-M-D',
          LANGUAGE.ENGLISH
        )
        .should.eql(new Date(2014, 3, 20))
      ...
      dateUtil
        .parse(
          '20 April, 2014 ESCAPE MM IN THE MIDDLE',
          'D MMMM, YYYY [ESCAPE MM IN THE MIDDLE]',
          LANGUAGE.ENGLISH
        )
        .should.eql(new Date(2014, 3, 20))
      ...
      dateUtil
        .parse(
          'ESCAPE 20 Apr ALL THE THINGS! M DDD, 2014',
          '[ESCAPE] DD MMM [ALL] [THE THINGS!] [M DDD], YYYY',
          LANGUAGE.ENGLISH
        )
        .should.eql(new Date(2014, 3, 20))
    ...
    describe('(HOOK_PARSER.D)', () => {
      it('parses a date string as the date', () => {
        ...
        dateUtil
          .parse('3 Apr, 2016', 'D MMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3))

        dateUtil
          .parse('20 Apr, 2016', 'D MMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 20))
    ...
    describe('(HOOK_PARSER.DD)', () => {
      it('parses a date string as the padded date', () => {
        ...
        dateUtil
          .parse('03 Apr, 2016', 'DD MMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3))

        dateUtil
          .parse('20 Apr, 2016', 'DD MMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 20))
    ...
    describe('(HOOK_PARSER.M)', () => {
      it('parses a date string as the month', () => {
        ...
        dateUtil
          .parse('3 4, 2016', 'D M, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3))

        dateUtil
          .parse('20 12, 2016', 'D M, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20))
    ...
    describe('(HOOK_PARSER.MM)', () => {
      it('parses a date string as the padded month', () => {
        ...
        dateUtil
          .parse('3 04, 2016', 'D MM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3))

        dateUtil
          .parse('20 12, 2016', 'D MM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20))
    ...
    describe('(HOOK_PARSER.MMM)', () => {
      it('parses a date string as the short named month', () => {
        ...
        dateUtil
          .parse('20 Dec, 2016', 'D MMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20))
    ...
    describe('(HOOK_PARSER.MMMM)', () => {
      it('parses a date string as the full named month', () => {
        ...
        dateUtil
          .parse('3 April, 2016', 'D MMMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3))

        dateUtil
          .parse('20 December, 2016', 'D MMMM, YYYY', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20))
    ...
    describe('(HOOK_PARSER.H)', () => {
      it('parses a date string as the 24-hours', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 17', 'D M, YYYY @ H', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('20 12, 2016 @ 2', 'D M, YYYY @ H', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 2))
    ...
    describe('(HOOK_PARSER.HH)', () => {
      it('parses a date string as the padded 24-hours', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 17', 'D M, YYYY @ HH', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('20 12, 2016 @ 02', 'D M, YYYY @ HH', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 2))
    ...
    describe('(HOOK_PARSER.h)', () => {
      it('parses a date string as the 12-hours', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 5 AM', 'D M, YYYY @ h A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 5))

        dateUtil
          .parse('3 4, 2016 @ 5 PM', 'D M, YYYY @ h A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('3 4, 2016 @ 5 a.m.', 'D M, YYYY @ h a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 5))

        dateUtil
          .parse('3 4, 2016 @ 5 p.m.', 'D M, YYYY @ h a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('20 12, 2016 @ 11 AM', 'D M, YYYY @ h A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 11))

        dateUtil
          .parse('20 12, 2016 @ 11 PM', 'D M, YYYY @ h A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 23))

        dateUtil
          .parse('20 12, 2016 @ 11 a.m.', 'D M, YYYY @ h a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 11))

        dateUtil
          .parse('20 12, 2016 @ 11 p.m.', 'D M, YYYY @ h a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 23))
    ...
    describe('(HOOK_PARSER.hh)', () => {
      it('parses a date string as the padded 12-hours', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 05 AM', 'D M, YYYY @ hh A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 5))

        dateUtil
          .parse('3 4, 2016 @ 05 PM', 'D M, YYYY @ hh A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('3 4, 2016 @ 05 a.m.', 'D M, YYYY @ hh a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 5))

        dateUtil
          .parse('3 4, 2016 @ 05 p.m.', 'D M, YYYY @ hh a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17))

        dateUtil
          .parse('20 12, 2016 @ 11 AM', 'D M, YYYY @ hh A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 11))

        dateUtil
          .parse('20 12, 2016 @ 11 PM', 'D M, YYYY @ hh A', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 23))

        dateUtil
          .parse('20 12, 2016 @ 11 a.m.', 'D M, YYYY @ hh a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 11))

        dateUtil
          .parse('20 12, 2016 @ 11 p.m.', 'D M, YYYY @ hh a', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 23))
    ...
    describe('(HOOK_PARSER.m)', () => {
      it('parses a date string as the minutes', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 17:8', 'D M, YYYY @ HH:m', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17, 8))

        dateUtil
          .parse('20 12, 2016 @ 02:13', 'D M, YYYY @ HH:m', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 2, 13))
    ...
    describe('(HOOK_PARSER.mm)', () => {
      it('parses a date string as the minutes', () => {
        ...
        dateUtil
          .parse('3 4, 2016 @ 17:08', 'D M, YYYY @ HH:mm', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 3, 3, 17, 8))

        dateUtil
          .parse('20 12, 2016 @ 02:13', 'D M, YYYY @ HH:mm', LANGUAGE.ENGLISH)
          .should.eql(new Date(2016, 11, 20, 2, 13))
    ...
    describe('(HOOK_PARSER.s)', () => {
      it('parses a date string as the minutes', () => {
        ...
        dateUtil
          .parse(
            '3 4, 2016 @ 17:08:6', 'D M, YYYY @ HH:mm:s',
            LANGUAGE.ENGLISH
          )
          .should.eql(new Date(2016, 3, 3, 17, 8, 6))

        dateUtil
          .parse(
            '20 12, 2016 @ 02:13:19', 'D M, YYYY @ HH:mm:s',
            LANGUAGE.ENGLISH
          )
          .should.eql(new Date(2016, 11, 20, 2, 13, 19))
    ...
    describe('(HOOK_PARSER.ss)', () => {
      it('parses a date string as the minutes', () => {
        ...
        dateUtil
          .parse(
            '3 4, 2016 @ 17:08:06', 'D M, YYYY @ HH:mm:ss',
            LANGUAGE.ENGLISH
          )
          .should.eql(new Date(2016, 3, 3, 17, 8, 6))
        ...
        dateUtil
          .parse(
            '20 12, 2016 @ 02:13:19', 'D M, YYYY @ HH:mm:ss',
            LANGUAGE.ENGLISH
          )
          .should.eql(new Date(2016, 11, 20, 2, 13, 19))
    ...
    describe('(HOOK_PARSER.x)', () => {
      it('parses a date string as the unix timestamp', () => {
        ...
        const date1 = new Date(2014, 3, 2, 4, 7, 51)
        dateUtil
          .parse(`${date1.getTime()}`, 'x', LANGUAGE.ENGLISH)
          .should.eql(date1)

        const date2 = new Date(2014, 11, 17, 18, 49, 3)
        dateUtil
          .parse(`${date2.getTime()}`, 'x', LANGUAGE.ENGLISH)
          .should.eql(date2)
  ...
  describe('#getFullMonthName', () => {
    ...
    it(
      'gets the full name of a specific month for the correct language',
    () => {
  ...
  describe('#getShortMonthName', () => {
    ...
    it(
      'gets the short name of a specific month for the correct language',
    () => {
  ...
  describe('#isSameDate', () => {
    ...
    it('returns `true` if two dates fall on the same date', () => {
      ...
      dateUtil
        .isSameDate(new Date(2015, 6, 28), new Date(2015, 6, 28))
        .should.eql(true)

      dateUtil
        .isSameDate(new Date(2015, 6, 28), new Date(2015, 6, 28).getTime())
        .should.eql(true)

      dateUtil
        .isSameDate(new Date().getTime(), new Date().getTime())
        .should.eql(true)
    ...
    it('returns `false` if two dates do not fall on the same date', () => {
      ...
      dateUtil
        .isSameDate(new Date(), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameDate(new Date(2015, 6, 27), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameDate(new Date(), new Date(2015, 6, 28).getTime())
        .should.eql(false)

      dateUtil
        .isSameDate(new Date().getTime(), new Date(2015, 6, 28).getTime())
        .should.eql(false)
  ...
  describe('#isSameMonth', () => {
    ...
    it('returns `true` if two dates fall on the same month', () => {
      ...
      dateUtil
        .isSameMonth(new Date(2015, 6, 11), new Date(2015, 6, 28))
        .should.eql(true)

      dateUtil
        .isSameMonth(new Date(2015, 6, 28), new Date(2015, 6, 11).getTime())
        .should.eql(true)

      dateUtil
        .isSameMonth(new Date().getTime(), new Date().getTime())
        .should.eql(true)
    ...
    it('returns `false` if two dates do not fall on the same month', () => {
      ...
      dateUtil
        .isSameMonth(new Date(), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameMonth(new Date(2015, 5, 28), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameMonth(new Date(2013, 6, 28), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameMonth(new Date(), new Date(2015, 6, 28).getTime())
        .should.eql(false)

      dateUtil
        .isSameMonth(new Date().getTime(), new Date(2015, 6, 28).getTime())
        .should.eql(false)
    ...
    it('returns `false` if invalid dates are passed', () => {
      ...
      dateUtil
        .isSameMonth({}, new Date(2015, 6, 28))
        .should.eql(false)
  ...
  describe('#isSameYear', () => {
    ...
    it('returns `true` if two dates fall on the same year', () => {
      ...
      dateUtil
        .isSameYear(new Date(2015, 10, 11), new Date(2015, 6, 28))
        .should.eql(true)

      dateUtil
        .isSameYear(new Date(2015, 6, 28), new Date(2015, 2, 11).getTime())
        .should.eql(true)

      dateUtil
        .isSameYear(new Date().getTime(), new Date().getTime())
        .should.eql(true)
    ...
    it('returns `false` if two dates do not fall on the same year', () => {
      ...
      dateUtil
        .isSameYear(new Date(), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameYear(new Date(2016, 6, 28), new Date(2015, 3, 28))
        .should.eql(false)

      dateUtil
        .isSameYear(new Date(2013, 6, 28), new Date(2015, 6, 28))
        .should.eql(false)

      dateUtil
        .isSameYear(new Date(), new Date(2015, 6, 28).getTime())
        .should.eql(false)

      dateUtil
        .isSameYear(new Date().getTime(), new Date(2015, 6, 28).getTime())
        .should.eql(false)
