...
import type { DatePickerConfig, ClassNameDynamic } from './types'
...
type Initialize = (HTMLElement, DatePickerStore, DatePickerConfig) => void
type Layout = (DatePickerStore, DatePickerConfig) => HTMLElement
