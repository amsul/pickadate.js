...
const createButtonLayout = createLayout(picker => {
  ...
  picker.addEventListener('active', () => {
    buttonElement.disabled = false
  })
  picker.addEventListener('inactive', () => {
...
export const createGridButton = createButtonLayout((element, picker) => {
  picker.addEventListener('grid.remote-active', () => {
    element.classList.add(picker.getConfig().className.grid__focused)
  })
  picker.addEventListener('grid.remote-inactive', () => {
...
const initializeInput = (inputElement, picker) => {
  ...
  inputElement.addEventListener('focus', () => {
    picker.triggerEvent('active')
    picker.triggerEvent('grid.remote-active')
  })
  inputElement.addEventListener('blur', () => {
    picker.triggerEvent('grid.remote-inactive')
  })
