...
DatePicker.prototype.nodes = function( isOpen ) {
    ...
    var
        ...
        createYearLabel = function() {
            ...
            // Additionally, set to an object with { min: <number>, max: <number> }
            // to manually set the year limits. Set { default: <number> } to 
            // provide default year selection
            var lowestYear, highestYear;
            if(settings.selectYears.min && settings.selectYears.max){
                lowestYear = settings.selectYears.min;
                highestYear = settings.selectYears.max;
                numberYears = true;
            } else {
                    ...
                    _.group({
                        ...
                        item: function( loopedYear ) {
                            return [
                                ...
                                // Set the value and selected index.
                                'value=' + loopedYear + ( focusedYear == loopedYear ? ' selected' : settings.selectYears.default == loopedYear || '' )
                            ]
                        }
                    }),
