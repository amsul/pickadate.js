    ...
    var
        ...
        P = PickerInstance.prototype = {
            ...
            open: function( dontGiveFocus ) {
                ...
                // Properly position the picker in a classic style
                // This has no effect on default style
                P.$root.css(
                    'margin-left',
                    $ELEMENT.offset().left - P.$root.offset().left +
                    // Take into account existing margin-left
                    parseInt(P.$root.css('margin-left'), 10)
                );
