    ...
    var
        ...
        P = PickerInstance.prototype = {
            ...
            start: function() {
                ...
                P._hidden = SETTINGS.formatSubmit ? $( '<input type=hidden name=' + SETTINGS.hiddenPrefix + ELEMENT.name + ( SETTINGS.hiddenPrefix ? '' : (SETTINGS.hiddenSuffix || '_submit') ) + ( $ELEMENT.data( 'value' ) ? ' value="' + PickerConstructor._.trigger( P.component.formats.toString, P.component, [ SETTINGS.formatSubmit, P.component.item.select ] ) + '"' : '' ) + '>' )[ 0 ] : undefined
